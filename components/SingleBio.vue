		...
		<div class="text-center mx-auto max-w-2xl md:max-w-7xl">
			<div class="grid grid-cols-12 gap-4 pt-10 pb-12">
				...
				>
					...
					<h3 class="pb-5 uppercase text-left body-font font-bold">{{ title }}</h3>
					<p class="text-left pb-5">{{ description }}</p>

					<div class="grid grid-cols-12 gap-4 pb-12">


						<div v-if="facebook != null" class="col-span-12 lg:col-span-4">
							<div class="pb-5">
						...
						<div v-if="instagram != null" class="col-span-12 lg:col-span-4">
							<div class="pb-5">
						...
						<div v-if="twitter != null" class="col-span-12 lg:col-span-4">
							<div class="pb-5">
